...
// ===================== KẾT NỐI SUPABASE =====================
const SUPABASE_URL = "https://tvytdcyqicibzjwvmxen.supabase.co";
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR2eXRkY3lxaWNpYnpqd3ZteGVuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA3OTU3OTUsImV4cCI6MjA3NjM3MTc5NX0.cFU1L-X5eMkjw_vRdQLA-XBuF2HMa49vCDkXx_lOHlc";
...
document.getElementById('wishForm').addEventListener('submit', async (e) => {
  ...
  if (!sender || !message) return alert("✖️ Vui lòng điền đầy đủ thông tin!");
...
async function checkPrivateWishes() {
  ...
  if (!checkName) return alert('✖️ Vui lòng nhập tên của bạn!');
